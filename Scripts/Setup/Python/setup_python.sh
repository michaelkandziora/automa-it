...
function setup_python() {
    ...
    echo "Python 3.12.3 wurde installiert"
    echo "Bitte installiere, falls erwünscht, mit 'pyenv install <VERSION>' die gewünschte Python Version"


    pyenv global 3.12.3
    echo "Python 3.12.3 wurde als globale Version gewählt"
    echo "Bitte definiere, falls erwünscht, mit 'pyenv global <VERSION>' die gewünschte globale Python Version"
}
